...
const {
  categoryRouter,
} = require("./Src/Routes/ApiRoutes/categoryRoutes.router");
const {
  subcategoryRouter,
} = require("./Src/Routes/ApiRoutes/subcategoryRoute");
...
app.use(
  cors({
    origin: ["http://localhost:5175", "https://ecommerceproject10.netlify.app"], // <-- add all frontend URLs
